package per.ect.challengemyteam.config.social;

import per.ect.challengemyteam.repository.SocialUserConnectionRepository;
import per.ect.challengemyteam.repository.CustomSocialUsersConnectionRepository;
import per.ect.challengemyteam.security.jwt.TokenProvider;
import per.ect.challengemyteam.security.social.CustomSignInAdapter;
