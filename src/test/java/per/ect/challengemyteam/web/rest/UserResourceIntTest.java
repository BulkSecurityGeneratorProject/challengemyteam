package per.ect.challengemyteam.web.rest;

import per.ect.challengemyteam.ChallengemyteamApp;
import per.ect.challengemyteam.domain.Authority;
import per.ect.challengemyteam.domain.User;
import per.ect.challengemyteam.repository.UserRepository;
import per.ect.challengemyteam.repository.search.UserSearchRepository;
import per.ect.challengemyteam.security.AuthoritiesConstants;
import per.ect.challengemyteam.service.MailService;
import per.ect.challengemyteam.service.UserService;
import per.ect.challengemyteam.service.dto.UserDTO;
import per.ect.challengemyteam.service.mapper.UserMapper;
import per.ect.challengemyteam.web.rest.errors.ExceptionTranslator;
import per.ect.challengemyteam.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = ChallengemyteamApp.class)
